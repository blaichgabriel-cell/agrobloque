...
const s = {
  ...
  body: { padding:'8px 0' },
  item: { display:'flex', alignItems:'center', gap:10, padding:'12px 14px', borderBottom:'0.5px solid #f0ede8' },
...
const items = [
  ...
  { icon:'👥', title:'Operarios', sub:'7 personas' },
  { icon:'🧪', title:'Productos e insumos', sub:'Abonos, fungicidas' },
