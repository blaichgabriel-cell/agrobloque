...
export default function Costos({ campoActivo, isGuest = false }) {
  ...
  return (
    <div style={{ background:'#f2f1ef', minHeight:'100vh' }}>
      ...
      {modal && (
        <div style={{ position:'fixed', top:0, left:0, right:0, bottom:0, background:'rgba(0,0,0,0.4)', zIndex:100, display:'flex', alignItems: typeof window !== 'undefined' && window.innerWidth >= 768 ? 'flex-start' : 'flex-end', justifyContent:'center' }} onClick={e => e.target===e.currentTarget && cerrarModal()}>
